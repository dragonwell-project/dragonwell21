...
{
  {
    ...
    _scopes_data_begin = this->data_begin() + _scopes_data_offset;
    _deopt_handler_begin = this->data_begin() + deoptimize_offset;
    _deopt_mh_handler_begin = this->data_begin() + deoptimize_mh_offset;
