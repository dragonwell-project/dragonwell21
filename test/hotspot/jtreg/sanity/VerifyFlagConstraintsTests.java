...
public class VerifyFlagConstraintsTests {
    public static void main(String[] args) throws Exception {
        ...
        FlagConstraintTester.create().run("-XX:CompileThreshold=1073741824")
               // .testEq("CompileThreshold", "1073741823")
    ...
    static class FlagConstraintTester {
        ...
        private OutputAnalyzer doRun(String[] flags, boolean updateInputs) throws Exception {
            ...
            OutputAnalyzer outputAnalyzer = ProcessTools.executeTestJava(cmds);
